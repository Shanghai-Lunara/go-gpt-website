...
$(function(){
	...
	if(nowNew>=startNew&&nowNew<=endNwe){
		document.querySelector('body').setAttribute('style','-webkit-filter:grayscale(100%)');
	}
})